...
<div class='container'>
   <div class='message'>
       <div class="row">
         <div class="col-lg-12">
         <h3 class="text-center">Thank you for shopping!</h3></div>
         </div>
       </div>
       ...
       <div class="card">
        ...
        $id=$_GET['view'];
        $order_query = mysqli_query($con, "SELECT * FROM `order` WHERE user_id='$user_id' AND id='$id'");
          ...
          ?>
           ...
           <div class='customer-details ' >
            <h2 class="text-center">Your Details</h2>
               ...
               <p><b> payment status : </b><span style="color:<?php 
            ...
            <a href='user_cat.php' class='btn'>Continue Shopping</a>
